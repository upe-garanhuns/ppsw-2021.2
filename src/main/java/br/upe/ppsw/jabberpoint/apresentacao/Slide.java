...
public class Slide {
	 ...
	 * @param area a instância de {@link Rectangle} que irá receber os
	 *             {@link SlideItem}
	 * @param view A instância de {@link ImageObserver}, o observer que recebe as
	 *             notificações dos itens que são desenhados na interface.
	 */
	...
	/**
	 * Obtém uma escala de proporção em função da altura, largura e tamanho da
	 * apresentação para exibição dos slides.
	 * 
	 * @param area um {@link Rectangle} contendo os dados de tamanho da
	 *             apresentação.
