...
public class BitmapItem extends SlideItem {
	...
	/**
	 * Cria uma nova instância de item de slide do tipo imagem, indicando sua
	 * posição em nível no slide.
	 * 
	...
	/**
	 * Inicializa um item do tipo imagem no nível mais externo e sem dado de imagem
	 * associado.
	 */
	public BitmapItem() {
		this(0, null);
