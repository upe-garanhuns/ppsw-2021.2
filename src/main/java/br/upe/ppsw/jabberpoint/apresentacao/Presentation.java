...
/**
 * Representa uma Apresentação no sistema. Composta por um título, lista de
 * slides e componente de visualização de dados do slide.
 */
public class Presentation {
	 ...
	 * 
	 * @param slideViewerComponent A instância do {@link SlideViewerComponent} a ser
	...
	/**
	 * Atualiza o slide atual da apresentação e atualiza o componente de
	 * visualização de dados com as informações a serem atualizadas na tela.
	 * 
	...
	/**
	 * Move a apresentação para o slide anterior, caso o slide atual não seja o
	 * primeiro.
	 */
	...
	/**
	 * Move a apresentação para o ptóximo slide, caso o slide atual não seja o
	 * último.
	 */
	 ...
	 * @return O {@link Slide} econtrado ou <code>null</code> caso o número do slide
	 *         informado seja zero ou maior do que a quantidade de slides da
	 *         apresentação.
	 */
	 ...
	 * 
	 * @return O {@link Slide} atual ou <code>null</code> caso não esteja sendo
	 *         exibida alguma apresentação.
	 */
