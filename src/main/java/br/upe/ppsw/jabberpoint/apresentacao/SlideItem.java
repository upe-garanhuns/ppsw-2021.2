...
/**
 * Representação abstrata de um item de {@link Slide} em uma
 * {@link Presentation}
 */
public abstract class SlideItem {
	...
	/**
	 * Cria uma nova instância de item em um slide, o {@link Style} aplicado está
	 * direatmente relacionado a esta posição.
	 * 
	 * @param lev
	 */
	 ...
	 * 
	 * @param g        A instância de {@link Graphics} que receberá o desenho do
	 *                 item do slide.
	 * @param observer A instância de {@link ImageObserver} recebe as notificações
	 *                 de alterações de itens da interface com o usuário
	 * @param scale    A escala de proporção para desenhar os itens na tela.
	 * @param style    A instância de {@link Style} a ser aplicada ao item, conforme
	 *                 a posição de ele ocupa no {@link Slide}.
	 * 
	 * @return Uma instância de {@link Rectangle} contendo os itens
	 *         {@link SlideItem} do {@link Slide}
	 */
